...
function CsvField(name, defaultValue){
    CsvField.super_.call(this, name, 'S', defaultValue);
}
util.inherits(CsvField, Field);

CsvField.prototype.type = 'String';

CsvField.prototype.import = function(value){
    if(value === 'null' || value === undefined){
        return null;
    }
    return value.split(',');
...
CsvField.prototype.export = function(value){
...
function LongField(name, defaultValue){
    LongField.super_.call(this, name, 'N', defaultValue);
}
util.inherits(LongField, Field);

LongField.prototype.defaultValue = '0';

LongField.prototype.type = 'Number';

LongField.prototype.import = function(value){
    if(value === undefined || value === null){
        return this.defaultValue;
    }
    return value;
...
LongField.prototype.export = function(value){
    if(value === undefined){
        return "0";
    }
    return value.toString();
...
module.exports.LongField = LongField;
