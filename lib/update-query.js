...
UpdateQuery.prototype.add = UpdateQuery.prototype.push;

// Remove an item from a set
//     update('song', 123).pop('tags', 'pop').commit();
UpdateQuery.prototype.pop = function(key, value){
    var op = {
        'action': 'DELETE',
        'attributeName': key
    };
...
UpdateQuery.prototype.remove = UpdateQuery.prototype.pop;
UpdateQuery.prototype.unset = UpdateQuery.prototype.pop;
...
UpdateQuery.prototype.commit = function(done){
    var extras = {};
    ...
    this.model.updateItem(this.alias, this.hash, this.ops, extras, done);
};
